...
plot_usmap(data = usmap_data, values = "Weight", color = "red") +
  scale_fill_continuous(low = "white", high = "red", name = "S&P 500 Weight", label = scales::comma) + theme(legend.position = "right")
